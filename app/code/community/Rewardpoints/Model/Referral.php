...
class Rewardpoints_Model_Referral extends Mage_Core_Model_Abstract
{
    ...
    public function subscribe(Mage_Customer_Model_Customer $parent, $email, $name, $voidEmailSubmit = false)
    {
        ...
        Mage::log("Referral.php subscribe() Referring User ID: " . $parent->getId(), null, "mylogfile.log");
        if ($voidEmailSubmit){
            return $this->save();
        }
    ...
    {
        Mage::log("Referral.php sendSubscription() Destination: " . $destination, null, "mylogfile.log");
        return;
...
*/
    ...
    {
        Mage::log("Referral.php sendConfirmation() Destination: " . $destination, null, "mylogfile.log");
        return;
