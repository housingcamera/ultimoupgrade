...
class Rewardpoints_Block_Adminhtml_Referralrules_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	$this->_objectId = 'id';
        ...
        $this->_formScripts[] = "
            ...
            checkTypes = function(){
                if ($('rule_action_type').getValue() == '".Rewardpoints_Model_Referralrules::RULE_ACTION_TYPE_DONTPROCESS."'){
                    $('rule_points').value = '1';
