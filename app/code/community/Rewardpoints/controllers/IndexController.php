...
class Rewardpoints_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            Mage::log("IndexController.php indexAction() Referring User email: " . $this->getRequest()->getPost('email'), null, "mylogfile.log");
    ...
    public function goReferralAction(){
        ...
        if ($decrypt = $this->getRequest()->getParam('decript')){
            ...
            Mage::log("IndexController.php Deactivated Line 119--> Referring User ID: " . $userId, null, "mylogfile.log");
        }
