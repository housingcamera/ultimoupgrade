...
class Rewardpoints_Block_Adminhtml_Renderer_Pointslink extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
        ...
        $points_type = array(Rewardpoints_Model_Stats::TYPE_POINTS_GP,
            Rewardpoints_Model_Stats::TYPE_POINTS_FB,
            Rewardpoints_Model_Stats::TYPE_POINTS_PIN,
            Rewardpoints_Model_Stats::TYPE_POINTS_TT);
