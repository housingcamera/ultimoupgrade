...
class Appmerce_EselectPlus_Model_Api_Moneris_Mpg_Httpspoststatus
{
    var $api_token;
    var $store_id;
    var $status;
    ...
    function toXML()
    {
        ...
        $xmlString = '';
        $xmlString .= "<?xml version=\"1.0\"?>" . "<request>" . "<store_id>$this->store_id</store_id>" . "<api_token>$this->api_token</api_token>" . "<status_check>$this->status</status_check>" . $reqXMLString . "</request>";
